...
<main id="main"><article>
  ...
  <section class="sources" id="sources"><h2>Sources and visual credit</h2><ul><li><a href="${plant.sourceUrl}">${escapeHtml(plant.sourceName)}</a></li>${mediaSource}<li><a href="https://www.knmi.nl/kennis-en-datacentrum/uitleg/zonnig">KNMI: sunshine and sunless days in the Netherlands</a></li></ul></section>
...
<footer class="site-footer"><div class="shell footer-grid"><div class="footer-brand"><img class="brand-wordmark" src="../assets/eve-plants-logo-v1.png" alt="Eve Plants" width="178" height="60" /><span>Eve Plants</span></div><p>Plant care for Amsterdam and Dutch homes.</p><div class="footer-links"><a href="./">Plant wiki</a><a href="../blog/">Journal</a><a href="../store/">Shop · soon</a></div><div class="footer-bottom"><span>© 2026 Eve Plants</span><span>Amsterdam · Noord-Holland by arrangement · Online</span><a href="#main">Back to top ↑</a></div></div></footer><script src="../script.js"></script>
</body></html>`;
}
